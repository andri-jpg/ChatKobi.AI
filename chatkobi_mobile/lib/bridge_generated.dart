...
class NativeImpl implements Native {
  ...
  Future<String> call({required String prompt, dynamic hint}) {
    var arg0 = _platform.api2wire_String(prompt);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_call(port_, arg0),
      parseSuccessData: _wire2api_String,
      constMeta: kCallConstMeta,
      argValues: [prompt],
      hint: hint,
    ));
  }

  FlutterRustBridgeTaskConstMeta get kCallConstMeta =>
...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  void wire_call(
    int port_,
    ffi.Pointer<wire_uint_8_list> prompt,
  ) {
    return _wire_call(
      port_,
      prompt,
  ...
  late final _wire_callPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Int64, ffi.Pointer<wire_uint_8_list>)>>('wire_call');
